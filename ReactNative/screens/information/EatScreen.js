	...
	async componentDidMount() {
		...
		autorun(() => {
			...
			if (this.state.language == this.props.profileStore.language) {
				...
				this._getEat(this.props.foodStore.food_id).then(
					_data => {
	...
	_getEat(food_id) {
		...
		return RNFetchBlob.config({
			...
			.fetch(
				...
				'https://ec2-13-125-205-18.ap-northeast-2.compute.amazonaws.com/FooTravel/eat',
...
export default inject('profileStore', 'foodStore')(observer(EatScreen));
